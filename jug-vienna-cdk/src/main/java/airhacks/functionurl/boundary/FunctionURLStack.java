...
public class FunctionURLStack extends Stack {
    ...
    Table create(Construct scope){
        return Table.Builder.create(scope, "JUGViennaTable")
        .billingMode(BillingMode.PAY_PER_REQUEST)
        .tableName("jug-vienna")
        .partitionKey(Attribute.builder().type(AttributeType.STRING).name("pk").build())
        .build();
    }
